...
public class S3Action {
	...
	public static final String[] action_names = { "Move", "Attack", "Harvest", "Stand_Ground", "Repair", "Train",
			"Build", "Cancel" };
	...
	public boolean equals(Object o) {
		if (o instanceof S3Action) {
			...
			if (m_targetUnit != a.m_targetUnit) {
				return false;
			}
			if (m_action != a.m_action) {
				return false;
			}
			if (m_parameters.size() != a.m_parameters.size()) {
				return false;
			}
